    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={`w-full px-3.5 py-2 rounded-lg border bg-white text-sm text-slate-900 transition-colors placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 ${
